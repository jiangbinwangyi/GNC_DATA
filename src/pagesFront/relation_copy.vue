<template>
  ...
  <el-row style="width: 100%" :gutter="20">
    <el-col :span="6">
      <div class="panel bar" style="margin-top:100px">
        <v-chart :options="barOption" class="echartBox" />
      </div>
      <div class="panel pie" style="margin-top:60px">
    ...
    <el-col :span="6">
      <div class="panel bar2" style="margin-top:100px">
        <v-chart :options="barOption2" class="echartBox" />
      </div>
      <div class="panel line2" style="margin-top">
        <el-table
          :data="tableData"
          height="215"
          border
        ...
        series: [
          {
            name: '校正速度Vx',
            type: 'line',
            data: [0, 0, 1, 1, 1, 1, 1, 2, 2, 3, 3, 3]
          },
          {
            name: '校正速度Vy',
            type: 'line',
            data: [0, 0, 0, 0, 0, 1, 1, 2, 2, 2, 2, 3]
          },
          {
            name: '校正速度Vz',
            type: 'line',
            data: [0, 0, 0, 0, 0, 0, 0, 1, 1, 2, 2, 2]
          }
        ]
      },
      pieOption: {
        ...
        series: [
          {
            ...
            type: 'line',
            smooth: true,
            data: [1, 1.2, 1.1, 1.8, 2.5, 2.1, 1.9, 1.6, 2.2, 1.7, 1.3, 1]
          },
          {
            name: '校正速度Vy',
            type: 'line',
            smooth: true,
            data: [0.5, 1, 0.8, 1.5, 2.1, 1.9, 1.7, 1.3, 1.9, 1.4, 1.1, 0.8]
          },
          {
            name: '包络下限',
            type: 'line',
            smooth: true,
            data: [0, 0.8, 0.5, 1.2, 1.8, 1.7, 1.3, 1, 1.6, 1.1, 0.6, 0.4]
          }
        ]
      },
      barOption2: {
