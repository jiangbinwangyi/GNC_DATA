<template>
  <div>
    ...
    >
      ...
      <el-table-column label="型号名称" prop="satelliteName" align="center" min-width="120">
        <template slot-scope="{row}">
      ...
      <el-table-column label="操作" align="center" width="200" class-name="small-padding fixed-width">
        <template slot-scope="{row}">
          <el-button type="primary" size="mini" @click="toTest(row)">
            查看编号
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="110px" style="width: 400px; margin-left:50px;">
        <el-form-item label="型号名称" prop="satelliteName">
...
<script>
import { fetchList, deleteArticle, createArticle, updateArticle } from '@/api/metaManage/satellite'
...
export default {
  ...
  data() {
    return {
      ...
      pvData: [],
      rules: {
        satelliteName: [{ required: true, message: '型号名称必填', trigger: 'blur' }]
      },
